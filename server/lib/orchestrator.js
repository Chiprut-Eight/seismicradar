...
async function updateSystemData(port) {
  try {
    ...
    const isNasaMissing = Object.keys(nasaRes.data).length === 0 || nasaRes.data.tec === "--" || nasaRes.data.tec === "No Granule" || nasaRes.data.tec === "NaN" || nasaRes.data.tec === "Format Error" || nasaRes.data.tec === "ללא נתונים כרגע";
